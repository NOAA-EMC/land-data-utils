...
#SBATCH --job-name=regrid_mswep_climo
#SBATCH -o regrid_mswep_climo.out
#
...
subset_name="conus"
data_source="MSWEP"
data_source_directory="/scratch4/NCEPDEV/land/data/evaluation/MSWEP/original/monthly/"
data_destination_directory="/scratch4/NCEPDEV/land/data/evaluation/MSWEP/"
...
data_source_file=${data_source_directory}"/MSWEP.v3.climatology.2015-2024.nc"
...
eval "time ncl regrid_mswep_climo.ncl"
